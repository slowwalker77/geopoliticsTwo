...
import { Mail, MessageCircle, ExternalLink, ArrowLeft } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-card rounded-lg border p-6 space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">일반 문의</h3>
                    <p className="text-sm text-muted-foreground">사이트 관련 문의사항</p>
                  </div>
                </div>
                <p className="text-muted-foreground">
                  사이트 기능, 콘텐츠, 또는 기술적 문제에 대한 문의사항이 있으시면 
                  GitHub 이슈를 통해 연락해 주세요.
                </p>
